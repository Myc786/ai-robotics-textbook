...
async def index_all_books():
    print('Starting to index all book content into Qdrant...')
    ...
    for i, file_path in enumerate(markdown_files):
        ...
        try:
            ...
            max_chunk_size = 2000  # Increase chunk size to reduce API calls
            chunks = []
            current_chunk = ""
            ...
            for j, chunk_content in enumerate(chunks):
                if chunk_content.strip():  # Only process non-empty chunks
                    ...
                    try:
                        ...
                        print(f'    Embedding generated for chunk {j+1}')
